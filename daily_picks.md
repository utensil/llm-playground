...
- Milestone-ish models/datasets/apps are categorized as news. Papers are for better understanding the mechanisms and not just a new model trained differently, good blogs are also counted as papers.
- News(including most new papers) are dated by the time they happened. Discoveries and some papers are dated by the time I noticeed their importance[^1].
...
| 4.20 | | | [EvalAI](https://github.com/Cloud-CV/EvalAI) |
...
| 4.16 | | |  [lean-premise-selection](https://github.com/BartoszPiotrowski/lean-premise-selection) |
| 4.16 | | | [ProofNet](https://github.com/zhangir-azerbayev/ProofNet) |
| 4.15 | |[MiniGPT-4](https://github.com/hollobit/GenAI_LLM_timeline/blob/main) |
| 4.15 | |[web-llm](https://github.com/mlc-ai/web-llm) |
| 4.14 | [Multimodal C4](https://arxiv.org/abs/2304.06939) |
| 4.14 | | | [LMFlow](https://github.com/OptimalScale/LMFlow) |
...
| 4.9 | | |  [data-centric-AI](https://github.com/daochenzha/data-centric-AI) |
...
|    3.1     |        | | [miniF2F](https://github.com/openai/miniF2F)       |
